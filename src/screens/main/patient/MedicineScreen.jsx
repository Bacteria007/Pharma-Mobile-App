    ...
    const [medicines, setMedicines] = useState([
        {
            ...
            price: 5.99,
            image: MyImages.med2,
            desc: 'Used for pain relief and fever reduction.',
        },
        {
            id: 2,
            name: 'Ibuprofen',
            price: 7.49,
            image: MyImages.med1,
            desc: 'Helps reduce inflammation and relieve pain.',
        },
        {
            id: 3,
            name: 'Aspirin',
            price: 6.29,
            image: MyImages.med3,
            desc: 'Used as a blood thinner and pain reliever.',
        },
        {
            id: 4,
            name: 'Vitamin C',
            price: 8.99,
            image: MyImages.med1,
            desc: 'Boosts immune health and antioxidant levels.',
        },
        {
            id: 5,
            name: 'Cough Syrup',
            price: 12.49,
            image: MyImages.med2,
            desc: 'Relieves cough and soothes throat.',
        },
        {
            id: 7,
            name: 'Pain Relief',
            price: 9.99,
            image: MyImages.med3,
            desc: 'Effective for general pain relief.',
        },
        {
            id: 8,
            name: 'Pain Relief',
        ...
        <>
            <View style={commonStyles.container}>
                ...
                <ScrollView>
                    ...
                    <Text onPress={() => navigation.navigate('PatientScreens', { screen: 'OtherSellers' })}
                        style={styles.otherSellerBtn}>
                        Search Other Store
                    </Text>
                </ScrollView>
            </View>
